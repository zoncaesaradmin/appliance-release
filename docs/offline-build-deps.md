...
| `inference` | `build-cache/ollama:…`, `build-cache/vllm-openai-cpu:…`, `build-cache/vllm-openai:…` | Runtimes for `std-llm-amd64`, `acc-llm-amd64`, and `acc-llm-arm64` (`export-inference-runtime-image-archive.sh`) |
